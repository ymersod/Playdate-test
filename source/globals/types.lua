-- Types.lua
---@alias ScreenState "title" | "rocks" | "upgrades" | "museum"
...
---@alias RockGeneric { health: number, maxHealth: number, rockType: RockType, rockTypeNumber: number, sprite: RockSprite, active: boolean, dropTable: DropValuesKvPs[]}
