...
---@alias RockGeneric { health: number, rockType: RockType, rockTypeNumber: number, sprite: RockSprite, active: boolean, dropTable: DropValuesKvPs[], heatToMatch: number, maxHealth: number, heatBuffer: number, rockName: string, rockValueMultiplier: number}
